...
export const PAGE_DIAGRAM_KIND = Object.freeze({
  ...
  '10-knowledge-base/geometry-3d/active-calibration-experiment-design.md': 'information-map',
  ...
  '10-knowledge-base/geometry-3d/epipolar-geometry-homographies-two-view.md': 'projection-rays',
  ...
  '10-knowledge-base/geometry-3d/fiducial-corner-localization.md': 'projection-rays',
  ...
  '10-knowledge-base/geometry-3d/optical-flow-scene-flow-first-principles.md': 'measurement-chain',
  ...
  '10-knowledge-base/geometry-3d/point-cloud-representations-voxelization-first-principles.md': 'representation-comparison',
  ...
  '10-knowledge-base/machine-learning/av-data-evaluation-fundamentals.md': 'benchmark-split-firewall',
  ...
  '10-knowledge-base/optimization/constrained-kkt-qp-sqp-first-principles.md': 'solver-loop',
  ...
  '10-knowledge-base/sensors/thermal-ir-radiometry-first-principles.md': 'measurement-chain',
  '10-knowledge-base/sensors/ultrasonic-proximity-sensing-models.md': 'beam-noise-model',
  ...
  '10-knowledge-base/state-estimation/robust-loss-covariance-consistency.md': 'uncertainty-geometry',
