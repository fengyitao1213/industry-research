...
For the reusable pulse-echo range model behind the close-in acoustic channel,
see [Ultrasonic Proximity Sensing Models](../../10-knowledge-base/sensors/ultrasonic-proximity-sensing-models.md).
