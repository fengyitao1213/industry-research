...
| Cluster | Promoted files |
|---|---|
| Static map lifecycle, heterogeneous-map merging, and movable-object quarantine | [Lifelong 3D Map Version Control](lifelong-3d-map-version-control.md), [Uni-Mapper Dynamic-Aware LiDAR Map Merging](uni-mapper-dynamic-aware-lidar-map-merging.md), [Potentially Dynamic Object Removal by Ground Projection](potentially-dynamic-object-removal-ground-projection.md) |
