...
| 3D point cloud semantic segmentation backbones | [MinkowskiNet](minkowskinet.md), [KPConv](kpconv.md), [Point Transformer V3](point-transformer-v3.md), [Superpoint Transformer](superpoint-transformer.md) |
