...
| 3D point cloud semantic segmentation backbones | [MinkowskiNet](minkowskinet.md), [KPConv](kpconv.md), [RandLA-Net](randla-net.md), [Cylinder3D](cylinder3d.md), [WaffleIron](waffleiron.md), [Point Transformer V3](point-transformer-v3.md), [OctFormer](octformer.md), [Superpoint Transformer](superpoint-transformer.md) |
...
| [Aggregated-Map Semantic Segmentation](../overview/aggregated-map-semantic-segmentation.md) | Offline map-scale segmentation pipeline; anchors the segmentation-backbone method pages (MinkowskiNet, KPConv, RandLA-Net, Cylinder3D, PTv3, OctFormer, Superpoint Transformer). |
