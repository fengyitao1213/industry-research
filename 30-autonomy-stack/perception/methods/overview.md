...
| Open-world and open-vocabulary perception | [OpenAD](openad.md), [OP3Det](op3det.md), [WildDet3D](wilddet3d.md), [DetAny3D](detany3d.md), [OW-OVD](ow-ovd.md), [Clipomaly](clipomaly.md), [S2M](s2m.md), [SAM 3](sam3.md), [3D-AVS](3d-avs.md), [Mosaic3D](mosaic3d.md), [SpaCeFormer](spaceformer.md), [OpenVox](openvox.md), [OVAD/OVODA Open-Vocabulary 3D Attributes](ovad-ovoda-open-vocab-3d-attributes.md), [Open-Vocabulary Panoptic Occupancy](open-vocabulary-panoptic-occupancy.md) |
...
| [Aggregated-Map Semantic Segmentation](../overview/aggregated-map-semantic-segmentation.md) | Offline map-scale segmentation pipeline; anchors the segmentation-backbone method pages: MinkowskiNet, SPVCNN, KPConv, PointNeXt, RandLA-Net, Cylinder3D, SphereFormer, WaffleIron, SalsaNext, RangeFormer, FRNet, Point Transformer V3, Point-Cloud Mamba / SSM Backbones, FlatFormer, OctFormer, Superpoint Transformer, 2DPASS, OpenScene, and Mosaic3D. |
