...
| 3D point cloud semantic segmentation backbones | [MinkowskiNet](minkowskinet.md), [KPConv](kpconv.md), [RandLA-Net](randla-net.md), [Cylinder3D](cylinder3d.md), [Point Transformer V3](point-transformer-v3.md), [OctFormer](octformer.md), [Superpoint Transformer](superpoint-transformer.md) |
