...
- DySS is routed through the sparse-query and streaming-temporal overviews pending official code or broader adoption; remaining sparse-query follow-ons should only become atomic pages when they add a non-duplicative method boundary beyond [SparseBEV](sparsebev.md), [DETR4D](detr4d.md), [Sparse4D](sparse4d.md), or [ForeSight](foresight.md).
