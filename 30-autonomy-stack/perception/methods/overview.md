...
| [Aggregated-Map Semantic Segmentation](../overview/aggregated-map-semantic-segmentation.md) | Offline map-scale segmentation pipeline; anchors the segmentation-backbone method pages (MinkowskiNet, SPVCNN, KPConv, RandLA-Net, Cylinder3D, SphereFormer, WaffleIron, SalsaNext, PTv3, OctFormer, Superpoint Transformer, 2DPASS). |
