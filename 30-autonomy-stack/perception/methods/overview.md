...
| 3D point cloud semantic segmentation backbones | [MinkowskiNet](minkowskinet.md), [SPVCNN](spvcnn.md), [KPConv](kpconv.md), [PointNeXt](pointnext.md), [RandLA-Net](randla-net.md), [Cylinder3D](cylinder3d.md), [SphereFormer](sphereformer.md), [WaffleIron](waffleiron.md), [SalsaNext](salsanext.md), [RangeFormer](rangeformer.md), [Point Transformer V3](point-transformer-v3.md), [FlatFormer](flatformer.md), [OctFormer](octformer.md), [Superpoint Transformer](superpoint-transformer.md), [2DPASS](2dpass.md) |
