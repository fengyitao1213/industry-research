...
| 3D point cloud semantic segmentation backbones | [MinkowskiNet](minkowskinet.md), [SPVCNN](spvcnn.md), [KPConv](kpconv.md), [RandLA-Net](randla-net.md), [Cylinder3D](cylinder3d.md), [SphereFormer](sphereformer.md), [WaffleIron](waffleiron.md), [SalsaNext](salsanext.md), [Point Transformer V3](point-transformer-v3.md), [FlatFormer](flatformer.md), [OctFormer](octformer.md), [Superpoint Transformer](superpoint-transformer.md), [2DPASS](2dpass.md) |
...
| [Aggregated-Map Semantic Segmentation](../overview/aggregated-map-semantic-segmentation.md) | Offline map-scale segmentation pipeline; anchors the segmentation-backbone method pages (MinkowskiNet, SPVCNN, KPConv, RandLA-Net, Cylinder3D, SphereFormer, WaffleIron, SalsaNext, PTv3, FlatFormer, OctFormer, Superpoint Transformer, 2DPASS). |
