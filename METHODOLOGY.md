...
- **Most recent maintenance refresh:** The 2026-05-24 loop routed OpenLiDARMap and FlexCloud through the map-construction, aggregated-map conditioning, source-registry, README, INDEX, and methodology surfaces as source-backed georeferenced map-conditioning references, while leaving SAM4D audit/source-hygiene wording and LAMM multi-session map-merging triage queued for later bounded passes.
