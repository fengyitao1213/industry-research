...
- **Most recent maintenance refresh:** The 2026-05-24 loop routed ZAHA through the aggregated-map semantic segmentation benchmark, hub, taxonomy, audit, source-registry, README, INDEX, and methodology surfaces as a source-backed facade-hierarchy proxy, while leaving OpenLiDARMap queued for a separate georeferenced map-conditioning pass.
