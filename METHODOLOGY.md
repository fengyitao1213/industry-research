...
- **Latest loop addition:** The recurring loop is now 40+ source-backed files plus source-backed refreshes; the newest batches refreshed the aggregated-map segmentation dataset/proxy landscape, promoted static-map lifecycle coverage through [Lifelong 3D Map Version Control](30-autonomy-stack/localization-mapping/slam-methods/lifelong-3d-map-version-control.md), [Potentially Dynamic Object Removal by Ground Projection](30-autonomy-stack/localization-mapping/slam-methods/potentially-dynamic-object-removal-ground-projection.md), [Uni-Mapper Dynamic-Aware LiDAR Map Merging](30-autonomy-stack/localization-mapping/slam-methods/uni-mapper-dynamic-aware-lidar-map-merging.md), [BeautyMap](30-autonomy-stack/localization-mapping/slam-methods/beautymap.md), and [Raymoval](30-autonomy-stack/localization-mapping/slam-methods/raymoval.md), added [Point-Cloud Mamba / SSM Backbones](30-autonomy-stack/perception/methods/point-cloud-mamba-ssm-backbones.md) as a research-stage efficiency branch for aggregated-map segmentation, promoted [LOSC](30-autonomy-stack/perception/methods/losc.md) as an atomic open-vocabulary LiDAR pseudo-label consolidation method, refreshed the map-hygiene ground-truth protocol workflow across semantic-map QA, publication gates, monitoring, and safety evidence, added a compact proxy/input/training selector for end-to-end aggregated-map semantic segmentation, and added an explicit FOD/adverse-airside proxy-boundary refresh across existing dataset, validation, and removal routes.
