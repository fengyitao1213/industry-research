...
This research corpus began as a 24-hour intensive research session on **2026-03-21/22** using Claude Opus 4.6 with a 1M context window, augmented by parallel web-searching research agents. It has since been expanded and reorganized into an 851-document research corpus, surfaced as 855 VitePress reader pages.
...
| Metric | Value |
|--------|-------|
| Core research documents | 851 |
| Reader pages | 855 |
| Total lines | 390k+ |
| Research agents spawned | 300+ |
| Companies researched | 25 |
| Method-level SLAM library | 157 SLAM-method documents including overview/audit |
...
2. **Add new platform research:** Create it in the appropriate `20-av-platform/<domain>/` directory for compute, sensors, networking/connectivity, drive-by-wire, power/electrical, diagnostics, ruggedization, or thermal material.
