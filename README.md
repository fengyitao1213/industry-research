...
| MLOps by scale | [MLOps Scale Research Scope](50-cloud-fleet/mlops/mlops-scale-research-scope.md), [MLOps Reference Architectures by Scale](50-cloud-fleet/mlops/mlops-reference-architectures-by-scale.md), [MLOps Migration Checklist](50-cloud-fleet/mlops/mlops-migration-checklist-by-scale.md), [MLOps Scorecards and KPIs by Scale](50-cloud-fleet/mlops/mlops-scorecards-and-kpis-by-scale.md), [Experiment Tracking and Reproducibility](50-cloud-fleet/mlops/experiment-tracking-reproducibility-by-scale.md), [Model Registry and Artifact Lifecycle](50-cloud-fleet/mlops/model-registry-artifact-lifecycle-by-scale.md), [Pipeline Orchestration and Release Workflows](50-cloud-fleet/mlops/pipeline-orchestration-release-workflows-by-scale.md), [Evaluation Platforms and Replay Gates](50-cloud-fleet/mlops/evaluation-platform-replay-gates-by-scale.md), [Dataset Split and Leakage Controls](50-cloud-fleet/mlops/dataset-split-leakage-controls-by-scale.md), [Model Monitoring and Drift Response](50-cloud-fleet/mlops/model-monitoring-drift-response-by-scale.md), [Site-Sliced Release Evidence](50-cloud-fleet/mlops/site-sliced-release-evidence-by-scale.md), [Feature and Embedding Store Operations](50-cloud-fleet/mlops/feature-embedding-store-ops-by-scale.md), [Offboard Labeler Registry](50-cloud-fleet/mlops/offboard-labeler-registry-by-scale.md), [GPU Queueing and FinOps](50-cloud-fleet/mlops/gpu-queueing-finops-by-scale.md), [Secure Artifact Attestation](50-cloud-fleet/mlops/secure-artifact-attestation-profile.md), [Federated and Privacy-Preserving Training Policy](50-cloud-fleet/mlops/federated-privacy-preserving-training-policy-by-scale.md), [LLMOps and Agent Evaluation](50-cloud-fleet/mlops/llmops-agent-evaluation-by-scale.md), and [Map-Derived Pseudo-Label Invalidation](50-cloud-fleet/mlops/map-derived-pseudo-label-invalidation-protocol.md) | Routes MLOps from notebook research through repeatable prototypes, production products, fleet-scale autonomy, regulated safety-critical release, and foundation-model/platform scale, covering data contracts, lineage, run authority and reproducibility levels, registry identity and alias authority, workflow state machines, evaluation manifests, replay/runtime gates, shadow/canary evidence, split/leakage firewalls, monitoring/drift response, label operations, registries, orchestration, serving, governance, autonomy-specific map/model/calibration evidence, centralization boundaries, concrete S0-S5 architecture patterns, migration gates, release blockers, scorecards, ODD-cell release evidence, feature/vector-store controls, offboard labeler governance, GPU queueing/FinOps, secure artifact signing/SBOM/provenance/registry verification, federated/hybrid/privacy-preserving training triggers, GenAIOps/LLMOps agent evaluation, and pseudo-label invalidation. |
...
| Localization and mapping | [Mapping and Localization](30-autonomy-stack/localization-mapping/overview/mapping-and-localization.md) | Covers HD maps, LiDAR SLAM, map-prior georeferenced construction, multi-session point-cloud map merging, point-cloud map-quality evaluation, map-free driving, map maintenance, infrastructure-aided localization, and occupancy grids. |
...
| `30-autonomy-stack/` | 459 | [World Models Overview](30-autonomy-stack/world-models/overview.md) | World models, perception, method-level perception, planning, localization, infrastructure-aided localization, SLAM, simulation, VLA/VLM, E2E driving, and multi-agent systems. |
...
| `50-cloud-fleet/` | 50 | [Cloud Backend Infrastructure](50-cloud-fleet/data-platform/cloud-backend-infrastructure.md) | Data engines, fleet data loops, MLOps, OTA/SUMS, observability, map operations, data governance, perception/SLAM reliability telemetry, and fleet management. |
