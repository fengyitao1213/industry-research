...
| ML-related SLAM for semantic maps | [ML-Related SLAM Research Scope](30-autonomy-stack/localization-mapping/overview/ml-related-slam-research-scope.md) | Connects learned registration, learned place recognition, semantic/dynamic SLAM, neural implicit and Gaussian SLAM, point-cloud removal, static-but-transient quarantine, multi-session map merging, learned map priors, and aggregated-map semantic segmentation into one research architecture. |
